...
# DB 생성 & Auto Commit
# 본인 DB 경로
conn = sqlite3.connect('E:\\py_workout\\python_workout\\resource\\database.db',isolation_level=None) # 본인 DB 경로
...
with open('./resource/word.txt','r') as f:
    for c in f:
        words.append(c.strip())     # strip 공백제거

# print(words)    # 단어 리스트 확인

input("Ready? Press Enter Key") # Enter Game Stat!
